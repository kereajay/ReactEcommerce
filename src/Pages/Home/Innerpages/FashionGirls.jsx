...
import { useGetGirlsFashionSearchQuery } from '../../../Redux/Store/Slices/Amazon'
...
function FashionGirls() {
    ...
    const { data, error, isLoading } = useGetGirlsFashionSearchQuery('search?query=fashion_girls&pages=5&country=US&sort_by=RELEVANCE&product_condition=ALL')
    return (
        <div>
            <div className="py-5">
                {error ? (
