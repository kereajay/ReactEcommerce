...
import { useGetPrimeSearchQuery } from '../../../Redux/Store/Slices/Amazon'
import Load from '../../Loading/Load'

function Prime() {
    const navigate=useNavigate()

    const { data, error, isLoading } = useGetPrimeSearchQuery('search?query=prime-exclusive&page=1&country=US&sort_by=RELEVANCE&product_condition=ALL')
    return (
        <div>
            <div className="py-5">
                {error ? (
