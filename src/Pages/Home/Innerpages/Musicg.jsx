...
import { useGetMusicSearchQuery } from '../../../Redux/Store/Slices/Amazon'
...
function Musicg() {
    ...
    const { data, error, isLoading } = useGetMusicSearchQuery('search?query=digital-music&page=1&country=US&sort_by=RELEVANCE&product_condition=ALL')
    return (
        <div>
            <div className="py-5">
                {error ? (
