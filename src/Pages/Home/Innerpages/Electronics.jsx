...
import { useGetElectronicsSearchQuery } from '../../../Redux/Store/Slices/Amazon'
...
function Electronics() {
    ...
    const { data, error, isLoading } = useGetElectronicsSearchQuery('search?query=electronics&page=4&country=US&sort_by=RELEVANCE&product_condition=ALL')
    return (
        <div>
            <div className="py-5">
                {error ? (
                                        ...
                                        <div>
                                            <div className='px-2 py-3 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] flex gap-4 w-[70%] m-auto dark:shadow-white/80 ' >
                                                ...
                                                <div onClick={()=>navigate(`/Details/${item.asin}`)}>
                                                    <img className='w-34 object-cover m-auto' src={item.
                                                        product_photo
                                                    } alt="" />
                                                </div>
                                                <div>
