...
import { useGetBoysFashionSearchQuery } from '../../../Redux/Store/Slices/Amazon'
...
function FashionBoys() {
    ...
    const { data, error, isLoading } = useGetBoysFashionSearchQuery('search?query=fashion_boys&page=1&country=US&sort_by=RELEVANCE&product_condition=ALL')
    return (
        <div>
            <div className="py-5">
                {error ? (
