...
import { useGetBabyFashionSearchQuery } from '../../../Redux/Store/Slices/Amazon'
import Load from '../../Loading/Load'


function Fashionbaby() {
    const navigate=useNavigate()

    const { data, error, isLoading } = useGetBabyFashionSearchQuery('search?query=fashion_baby&page=1&country=US&sort_by=RELEVANCE&product_condition=ALL')
    return (
        <div>
            <div className="py-5">
                {error ? (
