...
import { useGetGrocerySearchQuery } from '../../../Redux/Store/Slices/Amazon'
...
function Grocery() {
    ...
    const { data, error, isLoading } = useGetGrocerySearchQuery('search?query=grocery&page=1&country=US&sort_by=RELEVANCE&product_condition=ALL')
    return (
        <div>
            <div className="py-5">
                {error ? (
