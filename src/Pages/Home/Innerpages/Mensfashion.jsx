...
import { useGetMensFashionSearchQuery } from '../../../Redux/Store/Slices/Amazon'
...
function Mensfashion() {
    ...
    const { data, error, isLoading } = useGetMensFashionSearchQuery('search?query=fashion-mens&page=1&country=US&sort_by=RELEVANCE&product_condition=ALL')
    return (
        <div>
            <div className="py-5">
                {error ? (
